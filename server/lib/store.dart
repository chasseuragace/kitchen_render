...
final HomeDto home = const HomeDto(
  ...
  stores: [
    StoreDto(id: '1', name: "Soul Food", image: 'assets/images/stores/soul-food.png'),
    StoreDto(id: '2', name: "Forno Pizza", image: 'assets/images/stores/forno-pizza.png'),
    StoreDto(id: '3', name: "Street Kitchen", image: 'assets/images/stores/street-kitchen.png'),
    StoreDto(id: '4', name: "Brunch Bar", image: 'assets/images/stores/brunch-bar.png'),
    StoreDto(id: '5', name: "Bake House", image: 'assets/images/stores/bake-house.png'),
  ],
);
